...
mcmc_results_dir = file.path('/global','scratch','users','jessicakatz','forest_growth_synthesis','Outputs','Final_SSM_outputs')
...
lnD_nm <- 'slope_size' # slope_size if processing author's results; 'log_size' if running a clean set of SSMs
